$(document).ready(function () {
    ...
    */
    ...
    $("#ImprimirBodega").click(function () {
        var periodo = $("#PeriodoAnio").val();
        var mes = $("#PeriodoMes").val();
        window.open("/SAG2/MovimientosBodega/Imprimir?Periodo=" + periodo + "&Mes=" + mes, '', '');
    });

    $("#ExcelBodega").click(function () {
        var periodo = $("#PeriodoAnio").val();
        var mes = $("#PeriodoMes").val();
        window.open("/SAG2/MovimientosBodega/Excel?Periodo=" + periodo + "&Mes=" + mes, '', '');
    });

    $("#ImprimirSaldoBodega").click(function () {
        var periodo = $("#Periodo").val();
        var mes = $("#Mes").val();
        window.open("/SAG2/Bodega/Imprimir?Periodo=" + periodo + "&Mes=" + mes, '', '');
    });

    $("#ExcelSaldoBodega").click(function () {
        var periodo = $("#Periodo").val();
        var mes = $("#Mes").val();
        window.open("/SAG2/Bodega/Excel?Periodo=" + periodo + "&Mes=" + mes, '', '');
    });
